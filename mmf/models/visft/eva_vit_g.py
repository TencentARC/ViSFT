...
class Attention(nn.Module):
    def __init__(
            ...
            proj_drop=0., window_size=None, attn_head_dim=None, train_backbone=False):
        super().__init__()
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                 ...
                 window_size=None, attn_head_dim=None, train_backbone=False):
        super().__init__()
        self.norm1 = norm_layer(dim)
        self.attn = Attention(
            dim, num_heads=num_heads, qkv_bias=qkv_bias, qk_scale=qk_scale,
            attn_drop=attn_drop, proj_drop=drop, window_size=window_size, attn_head_dim=attn_head_dim, train_backbone=train_backbone)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 use_mean_pooling=True, init_scale=0.001, use_checkpoint=False, train_backbone=False):
        super().__init__()
        ...
        self.blocks = nn.ModuleList([
            Block(
                ...
                init_values=init_values, window_size=self.patch_embed.patch_shape if use_rel_pos_bias else None, train_backbone=train_backbone)
